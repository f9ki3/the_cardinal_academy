      ...
      <fieldset id="step1">
        ...
        <style>
          ...
          <div class="tab-buttons">
            <a href="junior_old.php" class="tab-btn active text-decoration-none">Old Student</a>
            <a href="junior.php" class="tab-btn text-muted text-decoration-none">New Student</a>
          </div>
