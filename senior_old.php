      ...
      <fieldset id="step1">
        ...
        <style>
          ...
          <div class="tab-buttons">
            <a href="senior_old.php" class="tab-btn active text-decoration-none">Old Student</a>
            <a href="senior.php" class="tab-btn text-muted text-decoration-none">New Student</a>
          </div>
