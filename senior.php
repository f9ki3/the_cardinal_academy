...
<head>
  ...
  <title>The Cardinal Academy - Senior High Registration</title>
    ...
    <form id="enrollmentForm" action="submit_admission.php" method="POST" enctype="multipart/form-data">
      ...
      <fieldset id="step1">
        ...
        <div class="tab-buttons">
            <a href="senior_old.php" type="button" class="tab-btn text-decoration-none text-muted" >Old Student</a>
            <a href="senior.php" type="button" class="tab-btn active text-decoration-none" >New Student</a>
        </div>
        ...
        <div class="row g-3">
          ...
          <div class="col-12 col-md-4">
            <label for="strand" class="form-label text-muted">Strand*</label>
            ...
            <div id="strand-error" class="invalid-feedback d-none">Strand is required.</div>
          </div>
          ...
          <div class="col-12 col-md-4">
              ...
              <div id="age_input-error" class="invalid-feedback d-none">Age must be at least 15 for Grade 11.</div>
          </div>
...
function toggleParentFields(parentType, isChecked) {
    ...
    fields.forEach(field => {
        ...
        if (isChecked) {
            ...
            // Mark as N/A so validation can skip it
            field.setAttribute('data-na-status', 'true');
            field.disabled = true;
            field.value = '';
            ...
            field.setAttribute('data-na-status', 'false');
...
function validateStep1() {
  const fields = [
    ...
    { id: 'strand', message: 'Strand is required' },
    ...
    // MIN AGE 15 for Grade 11/12
    { id: 'age_input', message: 'Age must be at least 15.', name: 'age', min: 15 }, 
...
// --- Step 2 Validation Logic (Submit) ---
...
// --- Button State Management (Agreement & Required Fields) ---
document.addEventListener("DOMContentLoaded", function () {
  ...
  function checkFormValidity() {
    ...
    // Submit enabled only if strict guardian fields + agreement are set
