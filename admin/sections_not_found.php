      ...
      <div class="row g-4">
        <div class="col-12">
          <div class="rounded p-5 text-center border shadow-sm">
            <img src="../static/images/artnotfound.svg"class="w-50" alt="">
            <h2 class="mb-3">No schedule entries yet.</h2>
            ...
            <a href="sectioning.php?nav_drop=true" class="btn btn-danger rounded rounded-4 mt-3">Add to Section</a>
          </div>
        </div>
      </div>
    </div>
