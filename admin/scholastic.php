                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-12 col-md-6 d-print-none">
                            <form method="get" class="input-group">
                                <input type="hidden" name="student_number" value="<?= htmlspecialchars($student_id) ?>">
                                <input class="form-control rounded-4" type="text" name="search" placeholder="Search by School, District, or Division" value="<?= htmlspecialchars($search_query) ?>">
                                <button class="btn border ms-2 rounded-4" type="submit"> 
                                    <i class="bi bi-search me-1"></i> Search
                                </button>
                                <button class="btn border ms-2 rounded-4" type="button" onclick="window.print()"> 
                                    <i class="bi bi-printer me-1"></i> Print
                                </button>
                                <?php if($student_id): ?>
                                    <a href="create_scholastic.php?student_number=<?= htmlspecialchars($student_id) ?>" class="ms-2 btn btn-danger text-light rounded-4 px-4">+ Add Record</a>
                                <?php endif; ?>
                            </form>
                        </div>
                    </div>
