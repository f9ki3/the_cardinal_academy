...
$student_number = isset($_GET['student_number']) ? htmlspecialchars($_GET['student_number']) : '';
...
<div class="d-flex flex-row">
  ...
  <div class="content flex-grow-1">
    ...
    <div class="container py-4">
     <form action="enroll_form2.php" method="POST">
          ...
          <div class="row g-3">
           ...
           <div class="col-md-6">
            ...
            <?php
                ...
                // MODIFIED SQL: Filtered to only $currentSchoolYear (e.g., 2025-2026)
                ...
                $result_sections = mysqli_query($conn, $sql); // Changed variable name to avoid conflict later
              ...
              <div class="border mt-3 rounded-4 p-3">
                ...
                <div class="row g-2 align-items-end">
                  <div class="col-md-5">
                    ...
                    <select class="form-select form-select-sm" id="uniformName">
                      ...
                      <?php while ($row = mysqli_fetch_assoc($result_uniforms)) : // Use $result_uniforms here ?>
                        <option 
                          value="<?= $row['id'] ?>" 
                ...
                <script>
                    function calculateUniformTotal() {
                      ...
                      window.updateSummary(); // Trigger summary update
                    }
            ...
            <script>
              $(document).ready(function () {
                ...
                $('#uniformName').on('change', function () {
                  ...
                  $('#uniformPrice').val(price ? "₱" + parseFloat(price).toFixed(2) : ''); // Format price for display
                });
              });
            </script>
...
document.addEventListener("DOMContentLoaded", function() {
  ...
  window.updateDiscount = function() { // Made global to be called by updateSummary
  ...
  discountType.addEventListener("change", window.updateDiscount);
  discountValue.addEventListener("input", window.updateDiscount);
});
</script>
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  window.updateSummary = function () {
    ...
    // Recalculate discount based on current inputs or use the pre-calculated value
    // Assuming updateDiscount is defined and accessible globally or locally in the setup script
    let discount = parsePeso(discountAmount.value); 
  ...
  // Function to wrap discount logic and ensure summary updates
  function handleDiscountChange() {
      // updateDiscount is assumed to be defined in the script above
  ...
  discountType.addEventListener("change", handleDiscountChange);

  // Listen to changes
  [plan, regFeeInput, tuitionInput, miscInput, uniformInput, discountValue, downInput]
