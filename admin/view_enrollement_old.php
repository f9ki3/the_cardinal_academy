    ...
    <div class="container py-4">
     <form action="check_student.php" method="POST">
      ...
      <div class="bg-white p-4 rounded-4">
        <h2>Student Enrollement Form</h2>
          ...
          <div class="row g-3">
            ...
            <div class="col-12 col-md-4">
              ...
              <input type="text" class="form-control" 
                    value="<?= htmlspecialchars($data['grade_level'] ?? '') ?>" >
            </div>
            ...
            <div class="col-12 col-md-4">
              ...
              <input type="text" class="form-control" 
                    value="<?= htmlspecialchars($data['birth_place'] ?? '') ?>" >
            </div>
            ...
            <div class="col-12 col-md-4">
              ...
              <input type="text" class="form-control" 
                    value="<?= htmlspecialchars($data['guardian_phone'] ?? '') ?>" >
            </div>
          ...
          <div class="row g-3">
            ...
            <div class="col-12 col-md-2">
              <button id="approve-btn" type="submit" name="action" value="approved" class="btn btn-danger text-light rounded-4 mt-3 w-100">
                <span class="btn-text">Check Student</span>
