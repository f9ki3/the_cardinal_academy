            ...
            <div class="container my-4">
              <div class="row mb-3">
                ...
                <div class="col-12 col-md-7 d-flex justify-content-between align-items-center flex-wrap gap-2">
                  ...
                  <!-- Create Button -->
                  <a href="create_parent.php?nav_drop=true" class="btn bg-main text-light rounded rounded-4 px-4">
                    + Create
                  </a>
                </div>
                    ...
                    <?php if (mysqli_num_rows($result) > 0): ?>
                      <?php while ($row = mysqli_fetch_assoc($result)): ?>
                        <tr class="clickable-row" data-id="<?= $row['user_id'] ?>">
                          ...
                          <td><p class="text-muted pt-3 pb-3 mb-0"><?= htmlspecialchars($row['phone_number']) ?></p></td>
