  ...
  <div class="content flex-grow-1">
    ...
    <form action="update_student_form.php" method="POST">
            <div class="bg-white p-4 rounded-4">
                ...
                <p class="m-0">Note: You can now view student information here.</p>
                <div class="row g-3">
                    
                    <!-- Hidden student_number -->
                    <input type="hidden" name="student_number" value="<?= htmlspecialchars($data['student_number'] ?? '') ?>">
                    ...
                    <input type="text" name="strand" class="form-control" value="<?= htmlspecialchars($data['strand'] ?? '') ?>">
                    </div>
                ...
                <div class="row g-3">
                    ...
                    <a href="scholastic.php?student_number=<?php echo $student_id?>"
                        class="btn btn-outline-danger rounded-4 mt-3 w-100 d-flex align-items-center justify-content-center">
                        <span class="spinner-border spinner-border-sm me-2 d-none"
                            role="status" aria-hidden="true" id="update-spinner"></span>
                        <span>View Scholastic</span>
                    </a>
                    </div>
                </div>
                </fieldset>
