...
<header class="border-bottom sticky-top bg-white py-3 px-4 shadow-sm">
  <div class="container-fluid d-flex align-items-center justify-content-between flex-nowrap">
    ...
    <div class="d-flex align-items-center flex-nowrap">
      ...
      <h3 class="m-0 text-nowrap">The Cardinal Academy</h3>
    </div>

    <!-- Notification Bell -->
   <?php if (in_array($_SESSION['role'] ?? '', ['Administrator', 'Assistant Principal', 'Registrar'])): ?>
...
/* Hide header and notifications when printing */
@media print {
    header,
    #notificationCanvas,
    .btn, /* optional: hide buttons if needed */
    #notifBell {
    ...
    .table-responsive {
        overflow: visible !important; /* Ensure table prints fully */
