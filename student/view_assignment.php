...
// If no assignment found, show message and exit
if (!$assignment) {
    echo "<!DOCTYPE html>
    <html lang='en'>
    <head>
    ...
    <body>
        <div class='card-center'>
            ...
            <h4 class='fw-bold text-danger mb-3'>Assignment Not Found</h4>
            <p class='text-muted mb-4'>The assignment may have been deleted or does not exist.</p>
            <a href='my_assignment.php' class='btn btn-danger btn-back'>
                <i class='bi bi-arrow-left-circle me-2'></i> Back to Assignments
            </a>
        </div>
    </body>
    </html>";
