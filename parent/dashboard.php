                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4 col-6">
                                    <div class="text-md-start">
                                        ...
                                        <span><?= date("F d, Y", strtotime($student['birthdate'])) ?></span>
                                    </div>
                                </div>
                                <div class="col-md-4 col-6">
                                    <div class="text-md-start">
                            ...
                            <div class="row w-100 g-2 mt-2 justify-content-center justify-content-lg-end">
                                <div class="col-4">
                                    <div class="text-center p-3 bg-accent-blue text-primary rounded w-100">
                                        <div class="fs-2 fw-bold"><?= $student['total_assignments'] ?></div>
                                        <div class="small">Assignments</div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-center p-3 bg-accent-blue text-primary rounded w-100">
                                        <div class="fs-2 fw-bold"><?= $student['total_submitted'] ?></div>
                                        <div class="small">Submitted</div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="text-center p-3 bg-accent-blue text-primary rounded w-100">
                                        <div class="fs-2 fw-bold"><?= $student['total_posts'] ?></div>
                        ...
                        <table class="table table-striped mb-0 align-middle">
                            ...
                            <tbody>
                                <?php foreach ($student['courses'] as $course): 
                                    $progressPercent = $course['assignment_count'] > 0 
                                        ? round(($course['submitted_assignment_count'] / $course['assignment_count']) * 100) 
                                        : 0;
                                ?>
                                <tr>
                                    <td class="text-start fw-semibold text-secondary"><?= htmlspecialchars($course['course_name']) ?></td>
                                    <td class="text-center text-secondary"><?= $course['assignment_count'] ?></td>
                                    <td>
                                        <div class="mb-1 small fw-semibold text-secondary text-center">
                                            <?= $course['submitted_assignment_count'] ?> / <?= $course['assignment_count'] ?> Submitted (<?= $progressPercent ?>%)
                                        </div>
