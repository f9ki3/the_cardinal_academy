...
<div class="container py-5">
  <div class="bg-white p-4 rounded-4 shadow-sm">
    ...
    <div class="row g-3 mb-4">
        ...
        <div class="col-12 col-md-1 d-flex flex-column align-items-center justify-content-center order-1 order-md-last text-center">
    ...
    <div class="row g-3">
        ...
        <div class="col-12 col-md-3">
            ...
            <input type="text" required name="guardian_name" id="guardian_name" class="form-control required-for-submit" placeholder="Enter guardian's name">
        </div>
    ...
    <div class="mt-4">
        ...
        <div class="form-check d-flex align-items-center justify-content-start">
            <input id="agreementCheckbox" class="form-check-input me-2 required-for-submit" type="checkbox">
